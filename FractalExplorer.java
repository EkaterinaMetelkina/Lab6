...
public class FractalExplorer {
    ...
    // Поле, содержащее объект с выпадающим списком для доступа к нему в разных методах класса.
    private JComboBox<FractalGenerator> myComboBox;
    // Поле, содержащее объект с кнопкой сброса для доступа к ней в разных методах класса.
    private JButton resetButton;
    // Поле, содержащее объект с кнопкой сохранения для доступа к ней в разных методах класса.
